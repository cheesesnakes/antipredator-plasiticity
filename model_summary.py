...
def parameter_summary():
    ...
    vars = [v for v in vars if v not in ["rugosity", "phi_rug", "lambda", "mu", "pi", "rugosity_std", "biomass_std"]]
    ...
    params = az.summary(model_data, var_names=vars, kind="all", filter_vars="like", round_to=3, hdi_prob=0.89)
    ...
    params = params.rename(columns={"Sd": "Standard Deviation", "Hdi_5.5%": "Lower 89% HDI", "Hdi_94.5%": "Upper 89% HDI", "Mcse_Mean": "MCSE Mean", "Mcse_Sd": "MCSE SD", "Ess_Bulk": "ESS Bulk", "Ess_Tail": "ESS Tail", "R_Hat": "R-Hat"})
    params = params[["Parameter", "Behaviour", "Model", "Variable",  "Mean", "Standard Deviation", "Lower 89% HDI", "Upper 89% HDI", "MCSE Mean", "MCSE SD", "ESS Bulk", "ESS Tail", "R-Hat"]]
    ...
    print("\nIntercepts summary:")
    print("========================================")
    intercepts = az.summary(model_data, var_names=["alpha"], kind="all", filter_vars="like", round_to=3, hdi_prob=0.89)
    ...
    intercepts = intercepts.rename(columns={"Sd": "Standard Deviation", "Hdi_5.5%": "Lower 89% HDI", "Hdi_94.5%": "Upper 89% HDI", "Mcse_Mean": "MCSE Mean", "Mcse_Sd": "MCSE SD", "Ess_Bulk": "ESS Bulk", "Ess_Tail": "ESS Tail", "R_Hat": "R-Hat"})
    intercepts.rename(columns={"Variable": "Plot ID"}, inplace=True)

    intercepts = intercepts[["Plot ID", "Behaviour", "Model", "Mean", "Standard Deviation", "Lower 89% HDI", "Upper 89% HDI", "MCSE Mean", "MCSE SD", "ESS Bulk", "ESS Tail", "R-Hat"]]
