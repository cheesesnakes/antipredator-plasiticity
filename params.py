params = {
    ...
    "beta_risk_treatment": [0, 0, 0.5, 0.75],
    "alpha_risk": 0.01,
    "sigma_risk": 0.1,
    # time model: foraging, vigilance, movement
    "beta_energy": [-0.2, 0.01, 0.1],
    "beta_risk": [-0.2, 0.1, -0.1],
    "alpha": [0.2, 0.1, 0.1],
    "sigma": [1, 1, 1],
    "beta_pi_risk": [1, -1, 1],
